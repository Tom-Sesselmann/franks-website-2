...
! function(a, b) {
    a.fn.coverflow = function(c) {
        ...
        J.remove(), "function" == typeof aW && aW(H), H.buildCoverflow = function() {
            z = H.find(".covers"), A = H.find("ul"), B = H.find("li"), C = H.find(".imgdiv"), D = C.find("a"), g = B.length, i = h = 1, k = 100, j = g * k, B.each(function(b) {
                var c = a(this),
                    d = b + 1;
